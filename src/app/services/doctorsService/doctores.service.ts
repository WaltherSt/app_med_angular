...
export class DoctoresService {
  ...
  getDoctors(): Observable<any> {
    return this.http
      .get<any>(`${this.url}/doctors`)
      .pipe(catchError(this.handleError));
  }

  deleteDoctor(id: string): Observable<any> {
    return this.http
      .delete(`${this.url}/doctors/${id}`)
      .pipe(catchError(this.handleError));
  }

  editDoctor(id: string): any {
    return this.http
      .get(`${this.url}/doctors/${id}`)
      .pipe(catchError(this.handleError));
  }

  updateDoctor(id: string, data: any) {
    return this.http
      .patch(`${this.url}/doctors/${id}`, data)
      .pipe(catchError(this.handleError));
  }

  createDoctor(data: any) {
    return this.http
      .post(`${this.url}/doctors`, data)
      .pipe(catchError(this.handleError));
  }

  getDoctorsBySpecialty(specialty_id: String): Observable<any> {
    return this.http
      .get<any>(`${this.url}/doctors/specialty/${specialty_id}`)
      .pipe(catchError(this.handleError));
  }
}
